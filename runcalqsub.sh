...
rm ~/getflow/$1_pnfs_$c'_PC_rootlist.txt'
		...
		cp ~/getflow/run_temp.job ~/getflow/runcalqsubdiff_PC$c.job
		sed -i "s@^Executable.*@Executable   = /usatlas/u/cher97/getflow/runcalqsubloop.sh@" ~/getflow/runcalqsubdiff_PC$c.job
		sed -i "s@^Arguments.*@Arguments       = $1 _pnfs $c PC \$(Process) $2 $3 $4@" ~/getflow/runcalqsubdiff_PC$c.job
		nof=$(($(wc -l <~/getflow/$1_pnfs_$c'_PC_rootlist.txt') - 2))
		sed -i "s@^Queue.*@Queue $nof@" ~/getflow/runcalqsubdiff_PC$c$i.job
		...
		rm -rf /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_PC_calq_subdiff'$2_v$3
		mkdir /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_PC_calq_subdiff'$2_v$3
		chmod +777 /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_PC_calq_subdiff'$2_v$3
		condor_submit runcalqsubdiff_PC$c.job
...
rm ~/getflow/$1_pnfs_$c'_CC_rootlist.txt'
		...
		cp ~/getflow/run_temp.job ~/getflow/runcalqsubdiff_CC$c.job
		sed -i "s@^Executable.*@Executable   = /usatlas/u/cher97/getflow/runcalqsubloop.sh@" ~/getflow/runcalqsubdiff_CC$c.job
		sed -i "s@^Arguments.*@Arguments       = $1 _pnfs $c CC \$(Process) $2 $3 $4@" ~/getflow/runcalqsubdiff_CC$c.job
		nof=$(($(wc -l <~/getflow/$1_pnfs_$c'_CC_rootlist.txt') - 2))
		sed -i "s@^Queue.*@Queue $nof@" ~/getflow/runcalqsubdiff_CC$c.job
		...
		rm -rf /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_CC_calq_subdiff'$2_v$3
		mkdir /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_CC_calq_subdiff'$2_v$3
		chmod +777 /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c'_CC_calq_subdiff'$2_v$3
		condor_submit runcalqsubdiff_CC$c.job
