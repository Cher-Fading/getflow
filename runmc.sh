...
# ./runmc.sh MCE211203.1 1.5 0.3 HITight False mc 313000 50
#echo $1
linenumber=0
raccount
while IFS= read -r line; do
	...
	sed -i "s@^Arguments.*@Arguments       = $1 _pnfs $co \$(Process) $2 $3 $4 $5 $7@" ~/getflow/condors/runmc_$co_$1_$2_$3_$4_$5.job
