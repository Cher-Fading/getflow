...
echo 'data type: '$dataset>>~/getflow/txts/$1_log.txt
	...
	sed -i "s@^Arguments.*@Arguments       = $1 _pnfs $co \$(Process) $2 $3 $4 $5 $runNum $ptCut $eta $isMC $ptTruthCut $dataset ${11}@" ~/getflow/condors/runmc_$co_$1_$2_$3_$4_$5.job
