...
#./runmc.sh MCE211203.1 1.5 0.3 HITight False mc 0.0 2.5
#echo $1
linenumber=0
bold=$(tput bold)
normal=$(tput sgr0)
...
while IFS= read -r line <&3; do
	...
	sed -i "s@^Arguments.*@Arguments       = $1 _pnfs $co \$(Process) $2 $3 $4 $5 $runNum $ptCut $eta $isMC $9@" ~/getflow/condors/runmc_$co_$1_$2_$3_$4_$5.job
