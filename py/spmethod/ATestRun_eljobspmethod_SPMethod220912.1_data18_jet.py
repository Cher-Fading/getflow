...
# pp only
# inputFilePath = '/atlasgpfs01/usatlas/data/cher97/data18_hi.00365678.calibration_CCPEB.merge.AOD.k1029_m2048/'
inputFilePath = '/atlasgpfs01/usatlas/data/cher97/data18_jet/'
# inputFilePath = '/atlasgpfs01/usatlas/data/cher97/grltest/'
...
alg.recenter = True
# alg.RunNum = 366011
# alg.QCal_name = 'MyAnalysis/qmean.1026-1.366011.k1029_m2048.tot.root'
alg.RefEta = 2.5
alg.Rem=0
