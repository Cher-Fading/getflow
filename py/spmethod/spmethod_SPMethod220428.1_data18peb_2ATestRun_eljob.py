...
# pp only
inputFilePath = '/atlasgpfs01/usatlas/data/cher97/'
ROOT.SH.ScanDir().filePattern( 'AOD.16198828._000032.pool.root.1').scan( sh, inputFilePath )
...
alg.recenter = True
alg.RunNum = 365678
alg.QCal_name = 'MyAnalysis/qmean.1026-1.365678.k1029_m2048.tot.root'
alg.RefEta = 2.5
