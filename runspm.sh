...
while IFS= read -r line; do
	...
	#cat run_PC$c.job
	rm -rf /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_PC_spmethod_sub'$2'/'
	mkdir /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_PC_spmethod_sub'$2'/'
	for ((i = 0; i < $2; i++)); do
		mkdie /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_PC_spmethod_sub'$2'/sub'$i
	done
	...
	#cat run_CC$c.job
	rm -rf /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_CC_spmethod_sub'$2/
	mkdir /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_CC_spmethod_sub'$2/
	for ((i = 0; i < $2; i++)); do
		mkdie /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$c_$d'_CC_spmethod_sub'$2'/sub'$i
	done
