...
mkdir -p /atlasgpfs01/usatlas/data/cher97/$1_pnfs_$3_$4_qmean_$6_$7
...
while IFS= read -r line; do
	if [ $5 -eq $linenumber ]; then
		...
		cp /usatlas/u/cher97/qmean/source/MyAnalysis/share/ATestRun_eljob.py $tempdir/'tempout'$3_$4$linenumber/
		echo $(ls)
