...
while IFS= read -r line; do
	if [ $4 -eq $((linenumber - offset)) ]; then
		...
		sed -i "s@.*alg.PrimLim.*@alg.PrimLim = ${15}@" $tempdir/'tempout'$3_$linenumber/ATestRun_eljob.py
